...
function st_enqueue_scripts() {
  wp_enqueue_script('gsap', get_theme_file_uri('//cdnjs.cloudflare.com/ajax/libs/gsap/3.11.3/gsap.min.js'), array(), false, true);
  wp_enqueue_script('gsap-scroll', get_theme_file_uri('//cdnjs.cloudflare.com/ajax/libs/gsap/3.11.3/ScrollTrigger.min.js'), array(), false, true);
