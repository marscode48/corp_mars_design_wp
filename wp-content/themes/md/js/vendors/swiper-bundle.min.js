...
!function (e, t) {
    ...
    _createClass(V, [{
      ...
      value: function slidesPerViewDynamic(e, t) {
        ...
        if (s.centeredSlides) {
          ...
          for (var _s28 = l + 1; _s28 < a.length; _s28 += 1) a[_s28] && !_e41 && (_t33 += a[_s28].swiperSlideSize, o += 1, _t33 > n && (_e41 = !0));
          for (var _s29 = l - 1; _s29 >= 0; _s29 -= 1) a[_s29] && !_e41 && (_t33 += a[_s29].swiperSlideSize, o += 1, _t33 > n && (_e41 = !0));
    ...
    s({
      ...
      if (t.params.observer) {
        if (t.params.observeParents) {
          ...
          for (var _t39 = 0; _t39 < _e49.length; _t39 += 1) o(_e49[_t39]);
        }
        o(t.$el[0], {
  ...
  var re = [function (e) {
    ...
    function l(e) {
      ...
      for (var _t41 = 0; _t41 < p.length; _t41 += 1) _t41 >= w && _t41 <= b && (void 0 === c || e ? C.push(_t41) : (_t41 > c && C.push(_t41), _t41 < d && E.push(_t41)));
    ...
    function c() {
      ...
      if (n.loadPrevNext) if (c > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
        ...
        for (var _e66 = i + _t47; _e66 < _s39; _e66 += 1) p(_e66) && o(_e66);
    ...
    function o(e) {
      ...
      if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (i = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), s.slides.removeClass(r), s.params.loop || s.params.virtual && s.params.virtual.enabled) for (var _e73 = 0; _e73 < i; _e73 += 1) s.$wrapperEl.children("[data-swiper-slide-index=\"".concat(t.realIndex + _e73, "\"]")).addClass(r);else for (var _e74 = 0; _e74 < i; _e74 += 1) s.slides.eq(t.realIndex + _e74).addClass(r);
            ...
            if (r.freeMode.momentum) {
              if (d.velocities.length > 1) {
                var _e76 = d.velocities.pop(),
                  ...
                  _i19 = _e76.time - _s46.time;
                t.velocity = _a30 / _i19, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (_i19 > 150 || u() - _e76.time > 300) && (t.velocity = 0);
              } else t.velocity = 0;
              ...
              if (_c4 < t.maxTranslate()) r.freeMode.momentumBounce ? (_c4 + t.maxTranslate() < -_m && (_c4 = t.maxTranslate() - _m), _p2 = t.maxTranslate(), _h = !0, d.allowMomentumBounce = !0) : _c4 = t.maxTranslate(), r.loop && r.centeredSlides && (_f = !0);else if (_c4 > t.minTranslate()) r.freeMode.momentumBounce ? (_c4 - t.minTranslate() > _m && (_c4 = t.minTranslate() + _m), _p2 = t.minTranslate(), _h = !0, d.allowMomentumBounce = !0) : _c4 = t.minTranslate(), r.loop && r.centeredSlides && (_f = !0);else if (r.freeMode.sticky) {
                var _e78;
                for (var _t50 = 0; _t50 < o.length; _t50 += 1) if (o[_t50] > -_c4) {
                  _e78 = _t50;
                  break;
                }
